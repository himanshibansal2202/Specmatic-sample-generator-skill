...
- **View Specmatic Test Reports** — link to the HTML report generated by
  Specmatic after the test command runs. Do not describe or add any sample-owned
  report renderer. Use the report path generated by the selected Specmatic
  runtime; do not assume a fixed path.
...
[<report-path-generated-by-specmatic>](<report-path-generated-by-specmatic>)
```
